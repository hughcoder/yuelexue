...
public class IndexArtConverter extends DataConverter {
    ...
    public ArrayList<MultipleItemEntity> convert() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            final int id = data.getInteger("course_id");
            final String imageUrl=data.getString("image_url_big");
            ...
            final MultipleItemEntity entity= MultipleItemEntity.builder()
                    .setItemType(IndexArtItemType.ITEM_INDEXARTITEM)
